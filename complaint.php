...
if(isset($_POST['submit'])) {
    ...
    <div id="right">
       ...
       <div class="container">
            <div class="row">
                <center><h1>Complaint has been submitted.</h1> <br><br><br>
                 <a href="index.html" class="btn btn-primary">Home</a> &nbsp&nbsp&nbsp
            <a href="complaint.php" class="btn btn-primary">Fill another Form</a></center>
            </div>      
       </div>
   <!-- <div style="width: 400px; height: 400px; margin: 10 auto;">
        <a href="index.html" class="btn btn-primary">Home</a> &nbsp&nbsp&nbsp
            <a href="complaint.php" class="btn btn-primary">Fill another Form</a>
</div> -->  
<?php
        header("form.php");
       exit();
